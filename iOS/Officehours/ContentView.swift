...
struct ContentView: View {
    ...
    @State private var editingItem: OfficehoursItem?
    ...
    private func row(for item: OfficehoursItem) -> some View {
        HStack {
            Button {
...
struct EditItemView: View {
    ...
    init(item: OfficehoursItem?, onSave: @escaping (String, String, Double, Date) -> Void) {
        self.item = item
        self.onSave = onSave
